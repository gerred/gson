...
rules: [/^(?:\w+)/,/^(?::)/,/^(?:[a-zA-Z0-9_$]+)/,/^(?:[\t ]+)/,/^(?:[\n\;])/,/^(?:$)/,/^(?:\n\b)/],
conditions: {"js":{"rules":[2,3,4,5],"inclusive":false},"INITIAL":{"rules":[0,1,5,6],"inclusive":true}}
};
return lexer;
})();
parser.lexer = lexer;
...
exports.parser = node_json;
exports.Parser = node_json.Parser;
exports.parse = function () { return node_json.parse.apply(node_json, arguments); };
